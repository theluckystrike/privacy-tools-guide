...
- Standard iOS security (2FA, strong password, regular updates) suffices
...
- Evaluate 2-4 months with Lockdown Mode to see if trade-offs are acceptable
...
- Implement Lockdown Mode with thoughtful exception management
...
- Lockdown Mode is baseline; add additional measures (see Advanced Hardening section)
