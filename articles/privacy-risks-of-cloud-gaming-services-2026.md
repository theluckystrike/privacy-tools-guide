...
Microsoft can target you with job ads for companies looking for "people who take regular breaks" (inferable from gaming patterns).
...
None of these competitors have third-party privacy audits. GeForce NOW, Xbox, and PlayStation have scale advantages that make switching difficult.
...
Server-side data deletion takes 30 days.
...
Some data shared with third parties is not recoverable.
...
PlayStation doesn't have explicit account closure, only user deletion.
