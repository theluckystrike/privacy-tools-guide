...
Low-quality video that's hard to prove tampered with
```
...
- Work with established journalists or legal organizations
...
- Report internally first per directive requirements
...
- Consult solicitor experienced in PIDA cases
...
- Report to regulatory authorities (ASIC)
