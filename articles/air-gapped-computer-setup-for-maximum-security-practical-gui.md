...
The trade-off is inconvenience. Data transfer requires deliberate action, software updates demand manual intervention, and the system cannot leverage cloud services. For those whose threat model justifies this trade-off, the isolation provides peace of mind that no remote exploitation can reach their sensitive work.
