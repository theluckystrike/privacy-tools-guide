...
Encrypted. Useless without your master password. Attackers can try dictionary attack on the local file (slow, takes months/years with Argon2), but no company is logging anything.
