...
This list is often incomplete. For full details, you need the manifest.
...
We audited Bitwarden's code. It uses `fetch()` to send passwords to their servers, but:
...
You don't need to be a programmer to spot this. Searching for domain names in the code ("Is this URL one I recognize?") catches 80% of malicious extensions.
