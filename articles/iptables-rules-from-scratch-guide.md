...
if you are on a remote server, flushing rules and setting DROP policies may lock you out. Keep a console session open or set a cron job to flush and accept all before you start.
