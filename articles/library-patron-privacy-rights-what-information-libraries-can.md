...
- Court Order (OrderlyRecords Act): Requires higher scrutiny and typically involves notification to the patron before records are disclosed
...
```bash
Using privacy-focused browser settings in library
...
```python
Basic concept of encrypting library database queries
