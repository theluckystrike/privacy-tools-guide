...
The folder name on cloud storage is random (d/), not "Personal Files". Cloud provider sees no meaningful names.
...
2. Store vault on fastest drive
 ...
 - Vault on internal SSD, cloud sync to Dropbox on external
