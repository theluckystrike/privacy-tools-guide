...
A Strava user runs from their home at 7 AM daily. A bad actor can:
...
Apple Health is the best among major platforms, but treat connected apps carefully.
...
If privacy is a concern, consider switching from Google Fit to Apple Health or privacy-focused alternatives.
...
Fitness apps are NOT covered by HIPAA unless they're explicitly medical devices or used by healthcare providers.
