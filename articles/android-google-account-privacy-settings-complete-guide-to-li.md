...
This does not stop Google from collecting data, but it prevents that data from being used to serve targeted advertisements. You will still see ads, but they will be less relevant to your interests.
...
**Consider using an alternative launcher** that does not include Google services by default, though this requires accepting some trade-offs in functionality.
