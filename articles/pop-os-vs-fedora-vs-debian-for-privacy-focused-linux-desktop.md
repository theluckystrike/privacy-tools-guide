...
Fedora implements a controlled telemetry system called . This system collects basic system information including hardware architecture, package names, and crash reports, but users can opt out during or after installation. The telemetry is designed to be transparent and auditable.
...
- NVIDIA driver integration is simple but locks you into GPU-specific behavior
