...
1. **Fire you for posts that damage the company's reputation**—even if made on personal accounts
2. **Terminate you for violating social media policies**—if those policies are lawful
3. **Use social media screening** during hiring and employment decisions
4. **Take action based on posts about coworkers** that constitute harassment
