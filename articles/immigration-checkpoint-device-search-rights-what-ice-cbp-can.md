...
You use encryption software like VeraCrypt or FileVault. Officers cannot force you to provide encryption keys for "basic" searches in some interpretations, but they can refuse entry, detain your device, or escalate to a "extended search" where the legal situation becomes murkier. The safest approach is encrypting everything with strong keys you can remember—officers can compel disclosure of passwords they consider "testimony," but the法律 landscape continues evolving.
...
The legal landscape continues evolving. Recent court cases have incrementally clarified (while also complicating) the border search doctrine:
