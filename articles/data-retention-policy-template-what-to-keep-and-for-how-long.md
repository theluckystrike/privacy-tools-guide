...
- **I'll cover the key**: categories of data to consider, recommended retention periods with rationale, and implementation examples you can use in your codebase.
